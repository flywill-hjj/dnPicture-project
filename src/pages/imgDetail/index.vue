<template>
  <view>
    ...
    <view class="user_rank">
      <view class="rank">
        <text class="iconfont icon-zanpress">{{ imgDetail.rank }}</text>
      </view>
      <view class="user_collect">
        <text class="iconfont icon-shoucang41">收藏</text>
      </view>
    </view>
    <!-- 点赞 结束 -->
        ...
        <view class="comment_item" v-for="item in hot" :key="item.id">
          ...
          <view class="comment_desc">
            ...
            <view class="comment_like">
              <text class="iconfont icon-zanpress">{{ item.size }}</text>
            </view>
          </view>
        </view>
      </view>
...
export default {
  ...
  methods: {
    ...
    handleSwiperAction(e) {
      ...
      //* 2.用户 右滑 imgIndex--
      //* 3.判断 数组是否越界问题！
      //* 4.左滑 e.direction==="left"&&this.imgIndex<img.length-1
